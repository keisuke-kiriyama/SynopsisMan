...
VALIDATION_NCODES_FILE_PATH = path.abspath(path.join(ACTIVE_NCODES_DIR_PATH, 'validation_ncodes.txt'))
...
def check():
    ...
    print("VALIDATION_NCODES_FILE_PATH: ", VALIDATION_NCODES_FILE_PATH)
