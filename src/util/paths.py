...
WORD_INDEXES_DIR_PATH = path.abspath(path.join(DATA_DIR_PATH, 'word_indexes'))
WORD_INDEXES_CONTENTS_PATH = path.abspath(path.join(WORD_INDEXES_DIR_PATH, 'contents'))
...
def check():
    ...
    print("WORD_INDEXES_DIR_PATH: ", WORD_INDEXES_DIR_PATH)
    print("WORD_INDEXES_CONTENTS_PATH: ", WORD_INDEXES_CONTENTS_PATH)
...
def mkdir():
    ...
    if not path.isdir(WORD_INDEXES_DIR_PATH):
        os.mkdir(WORD_INDEXES_DIR_PATH)
    if not path.isdir(WORD_INDEXES_CONTENTS_PATH):
        os.mkdir(WORD_INDEXES_CONTENTS_PATH)
